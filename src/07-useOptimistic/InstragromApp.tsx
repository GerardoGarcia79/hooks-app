...
export const InstagromApp = () => {
  ...
  const [optimisticComments, addOptimisticComment] = useOptimistic(
    ...
    (prevComments, newComment: string) => {
      ...
      return [
        ...prevComments,
        // ! la prop optimistic no tiene que ver con el hook, es una bandera nuestra del tipo
  ...
  const handleAddComment = async (formData: FormData) => {
    ...
    startTransition(async () => {
      ...
      // ! Código para revertir el proceso si falla
      // ! También podemos guardar desde antes el id, y eliminar el item
